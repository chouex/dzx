...
<?php if($space['spacenote']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=doing&amp;view=me" title="Показать все мои статусы" class="xi2"><?php echo $space['spacenote'];?></a><?php } else { ?><label for="mood_message" class="xi2">Пожалуйста, обновите Ваш статус. Опишите своё настроение </label><?php } ?>
</div>
...
$('mood_mystatus').innerHTML = '<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=doing&amp;view=me" title="Показать все мои статусы" class="xi2">'+s+'</a>';
});
$('mood_message').value = '';
...
<td class="moodfm_btn">
<button type="submit" name="addsubmit_btn" id="addsubmit_btn">Опубликовать</Button>
</td>
</tr>
<tr>
<td class="moodfm_f">
<span class="y">Осталось <strong id="maxlimit">200</strong> символов</span>

<?php if(!empty($_G['setting']['pluginhooks']['space_home_doing_sync_method'])) { ?>
<span>
Синхронизация:
<?php if($_G['group']['maxsigsize']) { ?>
<a title="Подпись" id="syn_signature" class="syn_signature" href="javascript:void(0);" onclick="checkSynSignature()">Подпись</a>
...
<label for="to_sign"><input type="checkbox" name="to_signhtml" id="to_sign" class="pc" value="1" />Подпись</label>
<?php } } ?>
