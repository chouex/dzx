...
0
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header.htm', 1340040166, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/footer.htm', 1340040166, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/header_common.htm', 1340040166, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
|| checktplrefresh('./template/default/forum/discuz.htm', './template/default/common/pubsearchform.htm', 1340040166, 'diy', './data/template/1_diy_forum_discuz.tpl.php', './template/default', 'forum/discuz')
;?>
...
<p>
<strong class="vwmy<?php if($_G['setting']['connect']['allow'] && $_G['member']['conisbind']) { ?> qq<?php } ?>"><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>" target="_blank" title="Мой сайт"><?php echo $_G['member']['username'];?></a></strong>
...
<p class="chart z">Сегодня: <em><?php echo $todayposts;?></em><span class="pipe">|</span>Вчера: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>Сообщений: <em><?php echo $posts;?></em><span class="pipe">|</span>Пользователи: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['setting']['lastmember']) { ?><span class="pipe">|</span>Приветствуем новеньких: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['setting']['lastmember']); ?>" target="_blank" class="xi2"><?php echo $_G['setting']['lastmember'];?></a></em><?php } ?></p>
<div class="y">
<?php if($_G['uid']) { ?><a href="home.php?mod=space&amp;uid=<?php echo $_G['uid'];?>&amp;do=thread&amp;view=me" title="Мои сообщения" class="xi2">Мои сообщения</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="search.php?mod=forum&amp;srchfrom=<?php echo $newthreads;?>&amp;searchsubmit=yes" title="Новые сообщения" class="xi2">Новые сообщения</a><?php } ?>
</div>
</div>
<?php } ?>
...
<div class="bm_h cl">
<span class="o">
<img id="category_<?php echo $cat['fid'];?>_img" src="<?php echo IMGDIR;?>/<?php echo $cat['collapseimg'];?>" title="Открыть / Закрыть" alt="Открыть / Закрыть" onclick="toggle_collapse('category_<?php echo $cat['fid'];?>');" />
</span>
<?php if($cat['moderators']) { ?><span class="y">Модераторы: <?php echo $cat['moderators'];?></span><?php } ?><?php $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? 'http://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<?php if(empty($forum['redirect'])) { ?><dd><em>Темы: <?php echo $forum['threads'];?></em>, <em>Сообщений: <?php echo $forum['posts'];?></em></dd><?php } ?>
<dd>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost">Последнее сообщение: <?php echo $forum['lastpost']['dateline'];?></a>
<?php } } else { ?>
Отсутствуют
<?php } } ?>
</dd>
...
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>Подразделы: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>Модератор: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
</td>
<td class="fl_i">
...
<div class="bm_h">
<?php if($detailstatus) { ?>
<span class="o"><a href="forum.php?showoldetails=no#online" title="Открыть / Закрыть"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="Открыть / Закрыть" /></a></span>
<h3>
...
- Рекорд онлайн <strong><?php echo $onlineinfo['0'];?></strong> был <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } else { ?>
<span class="o"><a href="forum.php?showoldetails=yes#online" title="Открыть / Закрыть"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="Открыть / Закрыть" /></a></span>
<h3>
<strong><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">Пользователей</a></strong>
