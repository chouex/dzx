...
0
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/common/header.htm', 1340040170, 'diy', './data/template/1_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/common/simplesearchform.htm', 1340040170, 'diy', './data/template/1_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/home/space_userabout.htm', 1340040170, 'diy', './data/template/1_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/common/footer.htm', 1340040170, 'diy', './data/template/1_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/common/header_common.htm', 1340040170, 'diy', './data/template/1_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
|| checktplrefresh('./template/default/home/space_home.htm', './template/default/common/pubsearchform.htm', 1340040170, 'diy', './data/template/1_diy_home_space_home.tpl.php', './template/default', 'home/space_home')
;?>
...
<?php } } ?><div class="z">
<a href="./" class="nvhm" title="Главная"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
...
<p>Ваш профиль заполнен на <?php echo $space['profileprogress'];?>%, <a href="home.php?mod=spacecp&amp;ac=profile" class="xi2">Заполни профиль сейчас!</a></p>
</div>
</div>
...
<div class="bm_h cl">
<span class="y">
<a href="home.php?mod=task">Сообщения</a>
</span>
<h2>Задачи</h2>
</div>
<div class="bm_c">
<p class="pbm">Здравствуйте,  <?php echo $_G['username'];?>! Для вас появились новые задачи, можете принять в них участие!</p>
<hr class="da m0" />
<dl class="xld cl">
...
Оплата:<?php echo $_G['setting']['extcredits'][$task['prize']]['title'];?> <strong class="xi1"><?php echo $task['bonus'];?></strong> <?php echo $_G['setting']['extcredits'][$task['prize']]['unit'];?>
<?php } elseif($task['reward'] == 'magic') { ?>
Оплата:Реквизит <?php echo $listdata[$task['prize']];?> <strong class="xi1"><?php echo $task['bonus'];?></strong> ед.
<?php } elseif($task['reward'] == 'medal') { ?>
Оплата:Медали <strong class="xi1">1</strong> шт.
<?php } elseif($task['reward'] == 'invite') { ?>
Оплата:Код приглашения <strong class="xi1"><?php echo $task['prize'];?></strong> шт.
<?php } elseif($task['reward'] == 'group') { ?>
Можно улучшитьГруппаУровень
<?php } ?>
</p>
<?php } ?>
</dd>
...
<div class="bm_h cl">
<span class="y">
<a href="home.php?mod=magic">Сообщения</a>
</span>
<h2>Реквизит</h2>
</div>
<div class="bm_c">
...
<?php echo $_G['setting']['extcredits'][$magic['credit']]['title'];?> <strong class="xi1"><?php echo $magic['price'];?></strong> <?php echo $_G['setting']['extcredits'][$magic['credit']]['unit'];?>/ед.
<?php } else { ?>
<strong class="xi1"><?php echo $magic['price'];?></strong> <?php echo $_G['setting']['extcredits'][$magic['credit']]['title'];?>/ед.
<?php } ?>
</p>
<p>
<?php if($magic['num'] > 0) { ?>
<a href="home.php?mod=magic&amp;action=shop&amp;operation=buy&amp;mid=<?php echo $magic['identifier'];?>" onclick="showWindow('magics', this.href);return false;" class="xi2 xw1">Купить</a>
<?php if($_G['group']['allowmagics'] > 1) { ?>
<span class="pipe">|</span>
<a href="home.php?mod=magic&amp;action=shop&amp;operation=give&amp;mid=<?php echo $magic['identifier'];?>" onclick="showWindow('magics', this.href);return false;" class="xi2">Подарить </a>
<?php } } else { ?>
<span class="xg1">Нет реквизита в наличии</span>
<?php } ?>
</p>
</dd>
</dl>
...
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php if($ols[$value['uid']]) { ?>Онлайн<?php } ?>" class="avt">
...
<div class="bm_h cl">
<span class="y">
<a href="misc.php?mod=ranklist&amp;type=member">Сообщения</a>
</span>
<h2>Позиции друзей</h2>
</div>
<div class="bm_c">
...
<?php } ?>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=friend&amp;view=visitor">Сообщения</a>
</span>
<h2>Гости</h2>
</div>
<div class="bm_c">
...
<div class="avt"><img src="<?php echo STATICURL;?>image/magic/hidden.gif" alt="Анонимные" /></div>
<p>Анонимные</p>
<span><?php echo dgmdate($value[dateline], 'u', 9999, $_G[setting][dateformat]);?></span>
<?php } else { ?>
<a href="home.php?mod=space&amp;uid=<?php echo $value['vuid'];?>" title="<?php if($ols[$value['vuid']]) { ?>Онлайн<?php } ?>" class="avt" c="1">
...
<?php } ?>
<a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>&amp;do=friend">Сообщения</a>
</span>
<h2>Друзья</h2>
</div>
<div class="bm_c">
<ul class="ml mls cl"><?php if(is_array($olfriendlist)) foreach($olfriendlist as $key => $value) { ?><li>
<a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php if($ols[$value['uid']]) { ?>Онлайн<?php } ?>" class="avt" c="1">
<?php if($ols[$value['uid']]) { ?><em class="gol"></em><?php } ?><?php echo avatar($value[uid],small);?></a>
<p><a href="home.php?mod=space&amp;uid=<?php echo $value['uid'];?>" title="<?php echo $value['username'];?>"><?php echo $value['username'];?></a></p>
<span><?php if($value['lastactivity']) { ?><?php echo dgmdate($value[lastactivity], 'u', 9999, $_G[setting][dateformat]);?><?php } else { ?>Топ(<?php echo $value['num'];?>)<?php } ?></span>
</li>
<?php } ?>
</ul>
</div>
...
<div class="bm">
<div class="bm_h cl">
<h2>Дни рождения друзей</h2>
</div>
<div class="bm_c">
<table cellpadding="2" cellspacing="4"><?php if(is_array($birthlist)) foreach($birthlist as $key => $values) { ?><tr>
<td align="right" valign="top">
<?php if($values['0']['istoday']) { ?>Сегодня<?php } else { ?><?php echo $values['0']['birthmonth'];?>-<?php echo $values['0']['birthday'];?><?php } ?>
</td>
...
<a href="home.php?mod=spacecp&amp;ac=avatar" title="Изменить аватар" id="edit_avt"><span id="edit_avt_tar">Изменить аватар</span><?php echo avatar($_G[uid],middle);?></a>
</div>
<p><a href="home.php?mod=space&amp;uid=<?php echo $space['uid'];?>" target="_blank" class="o xi2">Посетить мой сайт</a></p>
</th>
<td>
<h3 class="xs2">
<span class="y xw0 xs1">Всего: <em class="xi1"><?php echo $space['views'];?></em> Визиты</span>
...
<ul class="tb cl">
<li<?php echo $actives['we'];?>><a href="home.php?mod=space&amp;do=home&amp;view=we">Новости друзей</a></li>
<li<?php echo $actives['me'];?>><a href="home.php?mod=space&amp;do=home&amp;view=me">Мои новости</a></li>
<li<?php echo $actives['all'];?>><a href="home.php?mod=space&amp;do=home&amp;view=all">Все</a></li>
<?php if($_G['setting']['my_app_status']) { ?>
<li<?php echo $actives['app'];?>><a href="home.php?mod=space&amp;do=home&amp;view=app">Новости приложений</a></li>
<?php } ?>
...
<?php } else { ?>
<div class="bm bw0"><?php $_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space[uid]&amp;do=home&amp;view=me\">Все новости</a>";?><?php include template('home/space_menu'); } if($_GET['view'] == 'all') { ?>
<p class="tbmu">
<a href="home.php?mod=space&amp;do=home&amp;view=all&amp;order=dateline"<?php echo $orderactives['dateline'];?>>Последние новости</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=home&amp;view=all&amp;order=hot"<?php echo $orderactives['hot'];?>>Популярные новости</a>
</p>
<?php } elseif($_GET['view'] == 'app' && $_G['setting']['my_app_status']) { ?>
<p class="tbmu">
<a href="home.php?mod=space&amp;do=home&amp;view=app&amp;type=we"<?php echo $typeactives['we'];?>>Во что играют друзья</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=home&amp;view=app&amp;type=me"<?php echo $typeactives['me'];?>>Я владелец</a><span class="pipe">|</span>
<a href="home.php?mod=space&amp;do=home&amp;view=app&amp;type=all"<?php echo $typeactives['all'];?>>Во что мы играем</a>
</p>
<?php } elseif($groups) { ?>
<p class="tbmu">
<a href="home.php?mod=space&amp;do=home&amp;view=we"<?php echo $gidactives['-1'];?>>Все друзья</a><?php if(is_array($groups)) foreach($groups as $key => $value) { ?><span class="pipe">|</span><a href="home.php?mod=space&amp;do=home&amp;view=we&amp;gid=<?php echo $key;?>"<?php echo $gidactives[$key];?>><?php echo $value;?></a><?php } ?>
</p>
<?php } } else { include template('home/space_header'); ?><div id="ct" class="ct2 wp cl">
<div class="mn">
<div class="bm">
<div class="bm_h cl">
<h1 class="mt">Новости</h1>
</div>
<div class="bm_c">
<?php } ?>
...
<?php if($hotlist) { ?>
<h4 class="et"><a href="home.php?mod=space&amp;do=home&amp;view=all&amp;order=hot" class="y xw0">Популярные <em>&rsaquo;</em></a>Рекомендуемые новости</h4>
...
<a class="t" href="userapp.php?icon=<?php echo $value['icon'];?>" title="Показать все клики">
...
<h4 class="et">
<?php if($day=='yesterday') { ?>Вчера<?php } elseif($day=='today') { ?>Сегодня<?php } else { ?><?php echo $day;?><?php } ?>
</h4>
<?php } ?>
...
<?php if($morelist) { ?>
<p class="xg1 cl"><span onclick="showmore('<?php echo $day;?>', '<?php echo $user['uid'];?>', this);" class="unfold">Открыть</span></p>
...
<?php } else { ?>
<p class="emp">Новости отсутствуют</p>
<?php } if($filtercount) { ?>
<div class="i" id="feed_filter_notice_<?php echo $start;?>">
В зависимости от Ваших <a href="home.php?mod=spacecp&amp;ac=privacy&amp;op=filter" target="_blank" class="xi2 xw1">Настройка фильтра</a>,Защищено новостей: <?php echo $filtercount;?> (<a href="javascript:;" onclick="filter_more(<?php echo $start;?>);" id="a_feed_privacy_more" class="xi2">Посмотреть</a>)
</div>
<div id="feed_filter_div_<?php echo $start;?>" style="display:none;">
<h4 class="et">Блокировка новостей</h4>
<ul class="el"><?php if(is_array($filter_list)) foreach($filter_list as $value) { include template('home/space_feed_li'); } ?>
<li><a href="javascript:;" onclick="filter_more(<?php echo $start;?>);">&laquo; Закрыть</a></li>
</ul>
</div>
<?php } ?>
